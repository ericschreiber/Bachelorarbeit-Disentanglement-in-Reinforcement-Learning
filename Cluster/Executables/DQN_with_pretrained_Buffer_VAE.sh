...
#  *************** Hyperparameters ***************
#arguments: path to model, features, likeDQN, namefolder, random seed, epsilon decay (standard: #.999985), big Agent [normal, big, superbig]
/itet-stor/ericschr/net_scratch/BA/Executables/DQN_with_pretrained_Buffer_VAE_Pong.py $1 $2 $3 $4 $5 $6 $7

#  *************** Example  ***************
#"//<path_to_storage>//BA/models/TCBVAE/Buffered/BuffConvB0.01_TC0_Lat10VAE/ConvB0.01_TC0_Lat10VAE11-5" 10 "likeDQNWBN" "L1B1G0.01Long_Seed23_Epsnormal_big" 23 .9999985 "big"
