...
#  *************** Hyperparameters ***************
# latentDim random_seed likeDQN [likeDQN oder NotDQN]
/itet-stor/ericschr/net_scratch/BA/Executables/Autoencoder.py $1 $2 $3 

#  *************** Example  ***************
# # sbatch /path_to_storage/Executables/Autoencoder.sh 20 13 "likeDQN"
